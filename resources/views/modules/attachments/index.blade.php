                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="btn-group">
                                        <a class="btn btn-info" href="{{ route('attachments.create') }}">
                                                ...
                                                <table id="saveStage" class="display dataTable no-footer"
                                                    ...
                                                    @foreach($attachments as $attachment)
                                                        <tr role="row" class="odd">
                                                            <td class="sorting_1">{{ $attachment->name }}</td>
                                                            <td>{{ $attachment->type->text() }}</td>
                                                            <td>{{ $attachment->description }}</td>
                                                            <td class="center">
                                                                <a href="{{ route('attachments.edit', $attachment) }}" class="btn btn-tbl-edit btn-xs">
