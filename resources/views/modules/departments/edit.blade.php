<x-layouts.app title="Editar">
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:613px">
            ...
            <x-pages.page-bar title="Crear departamentox">
                <li>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        ...
                        <div class="card-body">
                            <form action="{{ route('departments.update', $department) }}" class="form-horizontal" method="POST">
                                @method('PUT')
                                @include('modules.departments.form', [ 'department' => $department ])
                            </form>
                        </div>
                    </div>
                </div>
