<x-layouts.app title="{{ config('app.name') }} | Departamentos">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="btn-group">
                                        <a class="btn btn-info" href="{{ route('departments.create') }}">
                                                ...
                                                <table id="saveStage" class="display dataTable no-footer"
                                                    ...
                                                    @foreach($departments as $department)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="center">
                                                                <a href="{{ route('departments.edit', $department) }}" class="btn btn-tbl-edit btn-xs">
