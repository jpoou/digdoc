<x-layouts.app title="{{ config('app.name') }} | Enfermedades">
    <div class="page-content-wrapper">
        <div class="page-content" style="min-height:613px">

            <x-pages.page-bar title="Enfermedades">
                <li class="active">Lista de Enfermedades</li>
            </x-pages.page-bar>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <div class="btn-group">
                                        <a class="btn btn-info" href="{{ route('diseases.create') }}">
                                                ...
                                                <table id="saveStage" class="display dataTable no-footer"
                                                    ...
                                                    @foreach($diseases as $disease)
                                                        <tr role="row" class="odd">
                                                            <td class="sorting_1">{{ $disease->name }}</td>
                                                            <td>{{ $disease->description }}</td>
                                                            <td class="center">
                                                                <a href="{{ route('diseases.edit', $disease) }}" class="btn btn-tbl-edit btn-xs">
